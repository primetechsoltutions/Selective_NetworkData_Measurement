...
## Ensure classes remain in com.ptsl.selective_network_sdk.* namespace
#-keeppackagenames com.ptsl.selective_network_sdk.**
#-repackageclasses 'com.ptsl.selective_network_sdk'
#
## --------- General SDK Protection ---------
#-keep class com.ptsl.selective_network_sdk.** { *; }
#-dontwarn com.ptsl.selective_network_sdk.**
#
## --------- Retrofit & OkHttp ---------
